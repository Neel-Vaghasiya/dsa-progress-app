...
const Sidebar = ({ topics = [], activeSlug, onSelectTopic, getTopicProgress, isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed top-14 left-0 bottom-0 w-72 bg-gray-950 border-r border-gray-800 overflow-y-auto z-20
      ...
      >
        <div className="px-3 py-4">
          <div className="flex items-center justify-between px-2 mb-3">
            ...
            <button
              onClick={onClose}
              className="lg:hidden p-1 rounded text-gray-500 hover:text-gray-200 hover:bg-gray-800"
            >
              <X className="h-4 w-4" />
            </button>
          </div>
